            ...
            <div className="relative flex justify-center items-start flex-col w-full h-[420px] sm:h-[540px] md:h-[calc(100vh-80px)] md:min-h-[500px] overflow-hidden">
              <div className="flex gap-2 h-full xl:gap-4 2xl:gap-8 w-full relative">
                ...
                <div className="absolute left-0 bottom-0 h-[65%] md:h-[85%] w-[32%] sm:w-[36%] md:w-[36%] lg:w-[40%] xl:relative xl:w-auto max-w-[300px] md:max-w-[500px] xl:max-w-none xl:flex-1 xl:h-full mx-auto xl:mx-0 order-1 overflow-hidden xl:overflow-visible z-1 xl:flex xl:justify-end bg-transparent">
                  ...
                  {leftCandidateInfo ? (
                    <div className="relative z-20 w-full h-full xl:w-full xl:max-w-[600px] flex justify-end bg-transparent">
                      <CandidateImage
                ...
                {/* Right Candidate */}
                <div className="absolute right-0 bottom-0 h-[65%] md:h-[85%] w-[32%] sm:w-[36%] md:w-[36%] lg:w-[40%] xl:relative xl:w-auto max-w-[300px] md:max-w-[500px] xl:max-w-none xl:flex-1 xl:h-full mx-auto xl:mx-0 order-3 overflow-hidden xl:overflow-visible z-0 xl:flex xl:justify-start bg-transparent">
                  <svg
                  ...
                  {rightCandidateInfo ? (
                    <div className="relative z-20 w-full h-full xl:w-full xl:max-w-[600px] flex justify-start bg-transparent">
                      <CandidateImage
