...
export function ControversiasSection({
      ...
      <div className="w-full space-y-8 md:space-y-12 lg:space-y-16 py-8 md:py-12 lg:py-16">
        ...
        >
          ...
          <Typography
            ...
            align={textAlign}
            weight="200"
            className={`max-w-full md:max-w-[18rem] flex md:justify-center ${itemsAlign} md:mx-auto text-xs md:text-sm lg:text-base`}
          >
        ...
        >
          ...
          <Typography
            ...
            align={textAlign}
            weight="200"
            className={`max-w-full md:max-w-[20rem] flex md:justify-center ${itemsAlign} md:mx-auto text-xs md:text-sm lg:text-base flex-col`}
          >
  ...
  return (
    <div className="relative flex lg:grid lg:grid-cols-2 gap-2 md:gap-16 lg:gap-16 border-t border-white">
