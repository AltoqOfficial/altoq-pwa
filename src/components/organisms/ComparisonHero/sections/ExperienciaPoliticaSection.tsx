      ...
      <div className="w-full space-y-16 grid lg:space-y-16 py-8 md:py-12 lg:py-16 items-center justify-center">
        ...
        >
          ...
          <Typography
            ...
            align={textAlign}
            weight="200"
            className={`max-w-full md:max-w-[18rem] flex md:justify-center ${itemsAlign} text-xs md:text-sm lg:text-base`}
          >
        ...
        >
          ...
          <Typography
            ...
            align={textAlign}
            weight="200"
            className={`max-w-full md:max-w-[20rem] flex flex-col space-y-2 md:justify-center ${itemsAlign} text-xs md:text-sm lg:text-base`}
          >
        ...
        >
          ...
          <Typography
            ...
            align={textAlign}
            weight="200"
            className={`max-w-full md:max-w-[20rem] flex md:justify-center ${itemsAlign} text-xs md:text-sm lg:text-base flex-col space-y-2`}
          >
