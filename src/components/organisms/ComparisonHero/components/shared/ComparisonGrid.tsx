...
import { MobileComparisonView } from "./ComparisonView";
 ...
 *
 * Renders a 3-column grid layout for comparing candidate data on desktop,
 * and a card toggle view on mobile.
 */
export function ComparisonGrid({
  ...
  return (
    <div className={className}>
      {/* Desktop View */}
      <div className="hidden md:block w-full border-t border-white space-y-12 lg:space-y-16 py-8 md:py-12 lg:py-16">
