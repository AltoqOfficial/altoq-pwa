            ...
            <div className="flex flex-col gap-3">
              ...
              >
                <div className="flex h-8 w-8 items-center justify-center rounded-full bg-neutral-100 transition-colors group-hover:bg-primary-50">
                  ...
                  >
                    <path d="M9.42 0H6.892v10.217c0 1.218-.972 2.218-2.182 2.218s-2.182-1-2.182-2.218c0-1.195.95-2.174 2.117-2.217V5.435C2.075 5.478 0 7.587 0 10.217 0 12.87 2.117 15 4.732 15c2.614 0 4.732-2.152 4.732-4.783V4.978a5.85 5.85 0 0 0 3.348 1.13V3.544C10.913 3.478 9.42 1.913 9.42 0" />
                  </svg>
                </div>
                TikTok
              </a>
